...
#ifndef CLS_ENDPOINT
#define CLS_ENDPOINT 0
#else
#define CLS_ENDPOINT 1
#endif
#define USBD_CLS_ENABLE             CLS_ENDPOINT
#define USBD_CLS_WMAXPACKETSIZE     64
#define USBD_CLS_HS_ENABLE          0
#define USBD_CLS_HS_WMAXPACKETSIZE  64
#define USBD_CLS_EP_BULKIN          5
#define USBD_CLS_EP_BULKOUT         5
#define USBD_CLS_EP_BULKIN_STACK    0
#define USBD_CLS_STRDESC         L"FastDAP"
#define USBD_CLS_SENDBUF_SIZE       64
#define USBD_CLS_RECEIVEBUF_SIZE    64
#if (((USBD_CLS_HS_ENABLE1) && (USBD_CLS_SENDBUF_SIZE    < USBD_CLS_HS_WMAXPACKETSIZE1)) || (USBD_CLS_SENDBUF_SIZE    < USBD_CLS_WMAXPACKETSIZE1))
#error "Send Buffer size must be larger or equal to Bulk In maximum packet size!"
#endif
#if (((USBD_CLS_HS_ENABLE1) && (USBD_CLS_RECEIVEBUF_SIZE < USBD_CLS_HS_WMAXPACKETSIZE1)) || (USBD_CLS_RECEIVEBUF_SIZE < USBD_CLS_WMAXPACKETSIZE1))
#error "Receive Buffer size must be larger or equal to Bulk Out maximum packet size!"
#endif
...
#define USBD_EP_NUM_CALC4           MAX((USBD_CLS_ENABLE    *(USBD_CLS_EP_BULKOUT    )), (USBD_CLS_ENABLE   *(USBD_CLS_EP_BULKIN)))
#define USBD_EP_NUM_CALC5           MAX(USBD_EP_NUM_CALC0, USBD_EP_NUM_CALC1)
#define USBD_EP_NUM_CALC6           MAX(USBD_EP_NUM_CALC2, USBD_EP_NUM_CALC3)
#define USBD_EP_NUM_CALC7           MAX(USBD_EP_NUM_CALC4, USBD_EP_NUM_CALC5)
#define USBD_EP_NUM_CALC8           MAX(USBD_EP_NUM_CALC6, USBD_EP_NUM_CALC7)
#define USBD_EP_NUM                (USBD_EP_NUM_CALC8)
...
#define USBD_CLS_IF_NUM            (USBD_ADC_ENABLE*2+USBD_MSC_ENABLE*1+USBD_CDC_ACM_ENABLE*2+USBD_HID_ENABLE*1+0)
...
#define USBD_CLS_IF_STR_NUM        (3+USBD_STRDESC_SER_ENABLE+USBD_ADC_ENABLE*3+USBD_CDC_ACM_ENABLE*2+USBD_HID_ENABLE+USBD_CLS_ENABLE)
...
#endif
#if    (USBD_CLS_ENABLE)
/*#if    (USBD_CLS_HS_ENABLE)   TODO: HS CLS
#define USBD_CLS_MAX_PACKET       ((USBD_CLS_HS_WMAXPACKETSIZE > USBD_CLS_WMAXPACKETSIZE) ? USBD_CLS_HS_WMAXPACKETSIZE : USBD_CLS_WMAXPACKETSIZE)
#else*/
#define USBD_CLS_MAX_PACKET        (USBD_CLS_WMAXPACKETSIZE)
/*#endif*/
#else
#define USBD_CLS_MAX_PACKET        (0)
#endif
...
#define USBD_MAX_PACKET_CALC2     ((USBD_CLS_MAX_PACKET   > USBD_CDC_ACM_MAX_PACKET1 ) ? (USBD_CLS_MAX_PACKET  ) : (USBD_CDC_ACM_MAX_PACKET1 ))
#define USBD_MAX_PACKET_CALC3     ((USBD_MAX_PACKET_CALC0 > USBD_MAX_PACKET_CALC1    ) ? (USBD_MAX_PACKET_CALC0) : (USBD_MAX_PACKET_CALC1    ))
#define USBD_MAX_PACKET           ((USBD_MAX_PACKET_CALC2 > USBD_MAX_PACKET_CALC3    ) ? (USBD_MAX_PACKET_CALC2) : (USBD_MAX_PACKET_CALC3    ))
